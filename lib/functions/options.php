...
function simple_customize_preview_js() {
	wp_enqueue_script( 'simple_customizer', get_template_directory_uri() . '/lib/admin/simple-options/customizer.js', array( 'jquery','customize-preview' ), '', true );
}
...
function options_output_styles() {
	...
	get_template_part('lib/admin/simple-options/css/output-styles.css');
